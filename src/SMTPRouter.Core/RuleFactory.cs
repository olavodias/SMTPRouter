...
public static class RuleFactory
{
    ...
    public static IRoutingRule Create(Rule ruleDefinition)
    {
        ...
        if (!RegisteredTypes.TryGetValue(ruleDefinition.Type, out var routingRuleType))
        ...
        if (ruleDefinition.Parameters is not null)
        {
            ...
            {
                var propertyInfo = routingRule.GetType().GetProperty(p.Key, BindingFlags.Public | BindingFlags.Instance);
